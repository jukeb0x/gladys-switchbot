...
module.exports = function (peripheral, valueMap) {
  ...
  const constructorName = (valueMap.get('2a00') || '').toString('utf-8').replace('\u0000', '').toLowerCase();
console.log('switchbot module : constructorname '+constructorName+' valuemap : '+valueMap);
