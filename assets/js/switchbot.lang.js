var translationsEN = {
  ...
  MESH_PAIR_DESCR: 'To be able to pair an Switchbot device, be sure that the current device is unpaired and wait for it (red ligth).',
  AWOX_RESET_OFFICIAL_VIDEO: 'See official Switchbot video',
...
var translationsFR = {
  ...
  MESH_PAIR_DESCR: 'Afin de lier correctement un périphérique Switchbot, soyez sûr que celui-ci n\'est pas déjà appairé et qu\'il soit en attente de le devenir (lumière rouge).',
  AWOX_RESET_OFFICIAL_VIDEO: 'Voir la vidéo officielle Switchbot',
